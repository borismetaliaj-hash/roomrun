...
// Address-match fallback added 2026-08-04 so a test/junk entry can be cleared without needing
// its internal id (which the /api/listings response never exposes to the client).
